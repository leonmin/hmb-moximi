		...
		data() {
			return {
				...
				detailData:[
					...
					{roleType:2,content:'哎，我这边是装修公司的，请问你最近有装修的需求吗？',audioStartTime:2450,audioEndTime:6765,isClick: false},
					{roleType:1,content:'哦，好的，你们装修的均价大概是多少啊？',audioStartTime:0,audioEndTime:0,isClick: false},
					{roleType:2,content:'呃，大概在1000到1万不等了',audioStartTime:11750,audioEndTime:15535,isClick: false},
					{roleType:1,content:'那，你们施工工期一般多久呢？',audioStartTime:0,audioEndTime:0,isClick: false},
					{roleType:2,content:'嗯，这个的话，具体要看你的房屋的面积的大小',audioStartTime:19920,audioEndTime:23995,isClick: false},
					{roleType:1,content:'还有，你们是线上网站还是线下实体店啊？',audioStartTime:0,audioEndTime:0,isClick: false},
					{roleType:2,content:'呃线上的话，也有线下实体店的话也，有的呢',audioStartTime:29850,audioEndTime:34135,isClick: false},
					{roleType:1,content:'嗯嗯好的，这些信息我记录了，如果有需要的话我再联系您，也感谢您的来电，再见！',audioStartTime:0,audioEndTime:0,isClick: false},
					],
					mobileCode: "获取验证码",
					time: 60,
					mobileTip: "",
				...
				for (let i = 0; i < this.detailData.length; i++) {
					if (index === i) {
						...
						if (this.detailData[index].isClick == true) {
							...
							console.log('开始播放1');
							var that = this;
							_inn.src = "https://byrobot-prod.oss-cn-hangzhou.aliyuncs.com/InboundRobotCommunicate/20191231/20191231MgMitk0000880771_user.wav"
							console.log('开始播放2');
							var flag = 0;
							_inn.play();
			...
			playRecord() {
				...
				this.totalPlay = !this.totalPlay
					...
					if (that.totalPlay) {
						...
						innerAudioContext.src = 'https://byrobot-prod.oss-cn-hangzhou.aliyuncs.com/InboundRobotCommunicate/20191231/20191231MgMitk0000880771.wav'
						// 音频进度更新事件
