		...
		data() {
			return {
				...
				detailData:[
					...
					{roleType:2,content:'喂，你好',audioStartTime:3210,audioEndTime:5190,isClick: false},
					{roleType:1,content:'在的，您请说。',audioStartTime:0,audioEndTime:0,isClick: false},
					{roleType:2,content:'啊，你的快递到了，请下楼来拿一下',audioStartTime:7930,audioEndTime:11890,isClick: false},
					{roleType:1,content:'请问是快递到了是吗',audioStartTime:0,audioEndTime:0,isClick: false},
					{roleType:2,content:'啊，对的对的',audioStartTime:15860,audioEndTime:18310,isClick: false},
					{roleType:1,content:'好的，麻烦放在楼下物业吧，谢谢。',audioStartTime:0,audioEndTime:0,isClick: false},
					{roleType:2,content:'嗯，好的拜拜',audioStartTime:23410,audioEndTime:25390,isClick: false},
				...
				for (let i = 0; i < this.detailData.length; i++) {
					if (index === i) {
						...
						if (this.detailData[index].isClick == true) {
							...
							console.log('开始播放1');
							var that = this;
							_inn.src = "https://byrobot-prod.oss-cn-hangzhou.aliyuncs.com/InboundRobotCommunicate/20191231/20191231SnDV080000880658_user.wav"
							console.log('开始播放2');
							var flag = 0;
							_inn.play();
