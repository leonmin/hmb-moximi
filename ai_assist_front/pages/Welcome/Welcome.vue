		...
		methods: {
			...
			welcomeShare() {
				...
				jweixin.onMenuShareAppMessage({
					...
					link: 'https://m.checkshirt-ai.com/h5poster/index.html#/pages/week/week', // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
				...
				jweixin.onMenuShareTimeline({
					title: '【魔小秘】您的专属智能来电助理', // 分享标题
					link: 'https://m.checkshirt-ai.com/h5poster/index.html#/pages/week/week',
					imgUrl: 'https://ai-assist.oss-cn-beijing.aliyuncs.com/aac/mxmlogo.png', // 分享图标
					success: function() {
						// 用户点击了分享后执行的回调函数
						const params = {}
