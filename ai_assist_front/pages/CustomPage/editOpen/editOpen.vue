	...
	<view class="editOpen">
		<view class="editOpenContain shadowE7">
			...
			<view class="openContent" :class="isRight?'greyText':''">
				<textarea maxlength="100" bindinput="textareaAInput" v-if="isDisable" v-model="openInput" placeholder="您好，我现在正在忙，您有什么事情可以简要的说明一下。"></textarea>
				<textarea maxlength="100" bindinput="textareaAInput" v-else disabled placeholder="在这里录下你想传达的留言"></textarea>
			</view>
			<view class="openBtn">
				<view>
